...
- Check on MB FAN1 behavior and try to supply a meaningful tach signal to the mainboard in case a setup does not make use of any of the system's fan headers. Some BIOSes will report fan errors if nothing is connected to the CPU fan header.
